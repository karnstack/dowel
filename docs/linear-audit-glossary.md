...
box-shadow:
  0 3px 8px lch(0 0 0/.125),
  0 2px 5px lch(0 0 0/.125),
  0 1px 1px lch(0 0 0/.125);

/* modal, command palette */
box-shadow:
  0 4px 40px lch(0 0 0/.10),
  0 3px 20px lch(0 0 0/.125),
  0 3px 12px lch(0 0 0/.125),
  0 2px 8px  lch(0 0 0/.125),
  0 1px 1px  lch(0 0 0/.125);
```
...
```css
transition: border .15s, background-color .15s, color .15s, opacity .15s;
```
