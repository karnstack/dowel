...
We reimplement the *visual language* — colour relationships, spacing, density,
...
:root {
  ...
  --dowel-fs-micro: .6875rem;  /* 11 */
  --dowel-fs-mini:  .75rem;    /* 12 */
  --dowel-fs-small: .8125rem;  /* 13 — workhorse */
  --dowel-fs-base:  .9375rem;  /* 15 */
  ...
  /* motion */
  --dowel-dur: .15s;
  --dowel-ease: cubic-bezier(.25, .46, .45, .94);

  /* elevation — two tiers, no more */
  --dowel-shadow-popover:
    0 3px 8px lch(0 0 0/.125), 0 2px 5px lch(0 0 0/.125),
    0 1px 1px lch(0 0 0/.125);
  --dowel-shadow-modal:
    0 4px 40px lch(0 0 0/.10),  0 3px 20px lch(0 0 0/.125),
    0 3px 12px lch(0 0 0/.125), 0 2px 8px lch(0 0 0/.125),
    0 1px 1px lch(0 0 0/.125);
}
```
...
```css
.dowel-dark, [data-dowel-theme="dark"] { /* colour overrides */ }
@media (prefers-color-scheme: dark) {
  :root:not([data-dowel-theme="light"]) { /* same overrides */ }
}
```
...
Breadcrumb *(plain)* · Pagination *(plain)*
**Disclosure** Accordion · Collapsible
**Display** Avatar · Badge *(plain)* · Card *(plain)* · Kbd *(plain)* ·
Callout *(plain)* · Code *(plain)* · Table *(plain)* · Separator · Progress ·
Meter · Skeleton *(plain)* · ScrollArea
